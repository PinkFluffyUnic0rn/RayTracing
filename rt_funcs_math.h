...
inline int rt_vector3_nearest_to_zero( rt_vector3 *v0, rt_vector3 *v1 );

inline rt_float rt_vector3_min_component( rt_vector3 *pV0 );

inline rt_float rt_vector3_max_component( rt_vector3 *pV0 );
